...
3） 此工程可以跑起来测试，建议使用chrome、firefox打开。
  全渠道PC网关/WAP支付产品消费交易示例地址为：http://IP：端口/upacp_demo_dg/index_08_dg.php
───────────
...
upacp_sdk_php
  ...
  │  ├批量文件样例
  │  │  │
  │  │  └DK00000000777290058110097201510130001I.txt┈┈┈┈┈┈┈┈┈批量订购文件样例（使用前请注意按照规范修改里面的字段）
  │  │ 
  │  └对账文件样例 
  │     │
  ...
  │  ├api_08_dg ┈┈┈┈┈┈┈┈┈ 网关产品
  │  │  │  
  │  │  ├Form_6_2_BackAuth.php ┈┈┈┈┈ 后台实名认证示例类
  │  │  │  
  │  │  ├Form_6_2_FrontAuth.php ┈┈┈┈┈ 前台实名认证示例类
  │  │  │  
  │  │  ├Form_6_3_Consume.php ┈┈┈┈┈ 订购消费示例类
  │  │  │  
  │  │  ├Form_6_4_ConsumeUndo.php ┈┈┈┈┈ 消费撤销示例类
  │  │  │  
  │  │  ├Form_6_5_Refund.php ┈┈┈┈┈ 退货示例类
  │  │  │  
  │  │  ├Form_6_6_Query.php ┈┈┈┈┈ 交易状态查询示例类
  │  │  │  
  │  │  ├Form_6_7_1_FrontPreauth.php┈┈┈┈┈ 预授权示例类（后台）
  │  │  │  
