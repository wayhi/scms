<form class="api-form" method="post" action="demo/api_08_dg/Form_7_2_FileTransfer.php" target="_blank">
<p>
<label>商户号：</label>
...
<a href="https://open.unionpay.com/ajweb/help/faq/list?id=95&level=0&from=0" target="_blank">respcode=99、98或http状态500</a><br>
<br>
另外请注意阅读：<br>
<a href="https://open.unionpay.com/ajweb/help/faq/list?id=119&level=0&from=0" target="_blank">对账文件什么时候能下载？</a><br>
<a href="https://open.unionpay.com/ajweb/help/faq/list?id=70&level=0&from=0" target="_blank">清算日期settleDate是什么？</a><br><br>
</p>
<hr />
<?php include $_SERVER ['DOCUMENT_ROOT'] . '/upacp_demo_dk/pages/more_faq.php';?>
</div>